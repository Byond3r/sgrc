...
if (isset($_SESSION["role"])) {
    switch ($_SESSION["role"]) {
        ...
        case "admin": {
                ...
                if (isset($_POST) && isset($_POST['action'])) {
                    ...
                    switch ($_POST['action']) {
                        case "ajouter table": {
                            ...
                            $num_table = htmlspecialchars($_POST['numero_table']); //Numéro n'est pas l'idée, il est visible
                            ...
                            $checkQuery = "SELECT id_table FROM sgr_table WHERE numero_table = :num_table";
                            $checkStatement = $pdo->prepare($checkQuery);
                            $checkStatement->bindParam(':num_table', $num_table, PDO::PARAM_INT);
                            $checkStatement->execute();
                            $existingTable = $checkStatement->fetch();
                        
                            if (!$existingTable) { //Si il n'existe pas on insère
                                $insertQuery = "INSERT INTO sgr_table (id_table, numero_table, type_table, vu) VALUES (NULL, :num_table, :type_table, :vu_table)";
                                $insertStatement = $pdo->prepare($insertQuery);
                                $insertStatement->bindParam(':num_table', $num_table, PDO::PARAM_INT);
                                $insertStatement->bindParam(':type_table', $type_table, PDO::PARAM_STR);
                                $insertStatement->bindParam(':vu_table', $vu_table, PDO::PARAM_INT);
                                $insertStatement->execute();
                                header('location: /SGRC/index.php?page=table'); //On repare sur la page qui présente la liste des tables
                            } else {
                        ...
                        case "update table": { 
                            ...
                            // Vérification si le numéro de table existe déjà sur une autre table
                            $checkQuery = "SELECT id_table FROM sgr_table WHERE numero_table = :num_table AND id_table <> :id_t";
                            $checkStatement = $pdo->prepare($checkQuery);
                            $checkStatement->bindParam(':num_table', $num_table, PDO::PARAM_INT);
                            $checkStatement->bindParam(':id_t', $id_t, PDO::PARAM_INT);
                            $checkStatement->execute();
                            $existingTable = $checkStatement->fetch();
                        
                            if (!$existingTable) { //Si le numéro n'existe pas sur une autre table, on modifie le numéro
                                $updateQuery = "UPDATE sgr_table SET numero_table = :num_table, type_table = :type_table, vu = :vu_tb WHERE id_table = :id_t";
                                $updateStatement = $pdo->prepare($updateQuery);
                                $updateStatement->bindParam(':num_table', $num_table, PDO::PARAM_INT);
                                $updateStatement->bindParam(':type_table', $type_table, PDO::PARAM_STR);
                                $updateStatement->bindParam(':vu_tb', $vu_tb, PDO::PARAM_INT);
                                $updateStatement->bindParam(':id_t', $id_t, PDO::PARAM_INT);
                        ...
                        case "vis table": { // Mettre à jour si on peut voir ou pas la table
                                if (isset($_POST['id_table'])) {
                                    $id_table = $_POST['id_table'];
                                    $view = $_POST['visibilite'];
                                    $statmt = $pdo->prepare('UPDATE `sgr_table` SET `vu` = :view WHERE `id_table` = :id_table;');
                                    $statmt->bindParam(':view', $view, PDO::PARAM_INT);
                                    $statmt->bindParam(':id_table', $id_table, PDO::PARAM_INT);
                                    $statmt->execute();
                                    header('location: /SGRC/index.php?page=table');
                                }
                                break;
                        ...
                        case "suppr table": { //Supprimer une table
                                if (isset($_POST['id_table'])) {
                                    $id_table = $_POST['id_table'];
                            ...
                            //ajout des boissons dans la base de données
                        case "ajout boisson": {
                            ...
                            //modifier les boissons dans la base de données
                        case "update boisson": {
                                $id_pl = htmlspecialchars($_POST['id_plat']);
                                $nom_pl = htmlspecialchars($_POST['nom_plat']);
                                $desc_pl = htmlspecialchars($_POST['description']);
                            ...
                            //Visibilité des boissons
                        case "vis boisson": {
                                if (isset($_POST['id_b'])) {
                                    $id_plat = $_POST['id_b'];
                                    $view = $_POST['visibilite'];
                                    $statmt = $pdo->prepare('UPDATE `plat` SET `vu` = :view WHERE `id_plat`= :id_plat ;');
                                    $statmt->bindParam(':view', $view, PDO::PARAM_INT);
                        ...
                        case "suppr boisson": {
                                if (isset($_POST['id_b'])) {
                                    ...
                                    $statmt->bindParam(':id_boisson', $id_boisson, PDO::PARAM_INT);
                                    $statmt->execute();
                                    header('location: /SGRC/index.php?page=boisson');
                                }
                                break;
                            }
                            //ajout des plats dans la base de données
                        case "ajout plat": {
                                $np = $_POST["nom_plat"];
                                ...
                                $vu_pl = $_POST['vu'];
                                //echo 
                                $statmt = $pdo->prepare("INSERT INTO `plat` (`id_plat`, `nom_plat`, `description`, `type_plat`, `PU_carte`, `id_sous_cat`, `vu`) VALUES (NULL, :np, :descr, :tp, :puc, :stp, :vu_pl);");
                                $statmt->bindParam(':np', $np, PDO::PARAM_STR);
                                $statmt->bindParam(':descr', $desc, PDO::PARAM_STR);
                                $statmt->bindParam(':tp', $tp, PDO::PARAM_STR);
                                $statmt->bindParam(':puc', $puc, PDO::PARAM_INT);
                                $statmt->bindParam(':stp', $stp, PDO::PARAM_STR);
                                $statmt->bindParam(':vu_pl', $vu_pl, PDO::PARAM_INT);
                                $statmt->execute();
                                header('location: /SGRC/index.php?page=plat');
                                break;
                            }
                            //modifier les plats dans la base de données
                        case "update plat": {
                                $id_pl = htmlspecialchars($_POST['id_plat']);
                                $nom_pl = htmlspecialchars($_POST['nom_plat']);
                                $desc_pl = htmlspecialchars($_POST['description']);
                        ...
                        case "ajout menu": {
                                ...
                                $statmt->bindParam(':nm', $nm, PDO::PARAM_STR);
                                $statmt->bindParam(':dm', $dm, PDO::PARAM_STR);
                                $statmt->bindParam(':Pm', $Pm, PDO::PARAM_STR);
                                $statmt->bindParam(':dtm', $dtm, PDO::PARAM_STR);
                                $statmt->bindParam(':vu', $vu, PDO::PARAM_INT);
                                $statmt->execute();
                        ...
                        case "update menu": {
                                ...
                                $stmt->bindParam(':id_m', $id_m, PDO::PARAM_INT);
                                $stmt->bindParam(':nom_m', $nom_m, PDO::PARAM_STR);
                                $stmt->bindParam(':desc_m', $desc_m, PDO::PARAM_STR);
                                $stmt->bindParam(':prix_u', $prix_u, PDO::PARAM_STR);
                                $stmt->bindParam(':vu_menu', $vu_menu, PDO::PARAM_INT);
                                $stmt->bindParam(':dtm', $dtm, PDO::PARAM_STR);
                                $stmt->execute();
                                header('location: /SGRC/index.php?page=menu');
                                break;
                            }
                        ...
                        case "suppr menu": {
                            ...
                            //Affichage des plats associés à un menu
                        case "carte menu": {
                                $id_m = $_POST['id_m'];
                        ...
                        case "suppr carte": {
                                ...
                                $statmt->bindParam('id_pl', $id_pl, PDO::PARAM_INT);
                                $statmt->execute();
                                break;
                            }
                            //Ajout d'un plat dans la carte
                            case "ajout carte": {
                                $id_m = $_SESSION['id_m'];
                                $id_p = $_POST['id_plat'];
                                ...
                                $statmt->bindParam(':id_p', $id_p, PDO::PARAM_INT);
                                $statmt->execute();
                                header('location: /SGRC/index.php?page=carte_menu');
                                break;
                            }
                        ...
                        case "suppr_utilisateur": {
                                ...
                                $statmt->bindParam('id_u', $id_u, PDO::PARAM_INT);
                                $statmt->execute();
                        ...
                        case "modif_utilisateur": {
                                ...
                                $statmt = $pdo->prepare("UPDATE user SET login = :nlog , role = :nrole , mdp = :nmdp WHERE id_user = :id_u");
                                $statmt->bindParam('nlog', $nouveau_login, PDO::PARAM_STR);
                                $statmt->bindParam('nrole', $nouveau_role, PDO::PARAM_STR);
                                $statmt->bindParam('nmdp', $nouveau_mot_de_passe, PDO::PARAM_STR);
                                $statmt->bindParam('id_u', $id_u, PDO::PARAM_INT);
                                $statmt->execute();
                            ...
                            //Ordre d'affichage catégorie, flêche vers le haut
                            //Monter la catégorie dans l'ordre d'affichage, c'est baisser son numéro
                        case "monter ordre cat": {
                                ...
                                if ($current_ordre > 1) { //On ne peut monter l'affichage d'une catégorie que si ce n'est pas la première
                                    $ordremoin = $current_ordre - 1;
                                    $stmt = $pdo->prepare("SELECT id_cat FROM categorie_plat WHERE ordre_affichage_cat = :ordremoin");
                                    $stmt->bindParam('ordremoin', $ordremoin, PDO::PARAM_INT);
                                    $stmt->execute();
                                    ...
                                    $stmt->bindParam('current_ordre', $current_ordre, PDO::PARAM_INT);
                                    $stmt->bindParam('previousId', $previousId, PDO::PARAM_INT);
                                    $stmt->execute();
                                }
                                break;
                            }
                            //Ordre d'affichage sous-catégorie dans la catégorie, flêche vers le haut
                            //Monter la catégorie dans l'ordre d'affichage, c'est baisser son numéro
                        case "monter ordre sscat": {
                            ...
                            //Ne pas supprimez
                            //Permet de ne pas afficher un message d'erreur à la demande de l'affichage de la page sous-catégorie
                        case "sous_categorie": {
                                break;
                            }
                            //Ordre d'affichage catégorie, flêche vers le bas
                            //Descendre la catégorie dans l'ordre d'affichage, c'est augmenter son numéro
                        case "descendre ordre cat": {
                                ...
                                if ($current_ordre < $maximum) { //On peut pas baisser une catégorie, si c'est la dernière catégorie qui s'affiche
                                    $ordreplus = $current_ordre + 1;
                                    $sql = "SELECT id_cat FROM categorie_plat WHERE ordre_affichage_cat = :ordreplus";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->bindParam(':ordreplus', $ordreplus, PDO::PARAM_INT);
                                    $stmt->execute();
                                    $previousValue = $stmt->fetch(PDO::FETCH_ASSOC);
                                    $previousId = $previousValue['id_cat'];
                            ...
                            //Ordre d'affichage sous-catégorie dans la catégorie, flêche vers le bas
                            //Baisser la catégorie dans l'ordre d'affichage, c'est monter son numéro
                        case "descendre ordre sscat": {
                                $ssid = htmlspecialchars($_POST['id_t']);
                                $id = htmlspecialchars($_POST['id_c']);
                                $sql = "SELECT ordre_aff_sous_cat FROM sous_categorie WHERE id_sous_cat = :id AND id_cat = :ssid";
                                $stmt = $pdo->prepare($sql);
                                $stmt->bindParam('id', $id, PDO::PARAM_INT);
                                ...
                                $current_ordre = $currentValue['ordre_aff_sous_cat'];
                                $sql = "SELECT MAX(ordre_aff_sous_cat) FROM sous_categorie WHERE id_cat = :ssid";
                                $stmt = $pdo->prepare($sql);
                                $stmt->bindParam('ssid', $ssid, PDO::PARAM_INT);
                                $stmt->execute();
                                $row = $stmt->fetch();
                                $maximum = $row['MAX(ordre_aff_sous_cat)'];
                                if ($current_ordre < $maximum) { //On peut pas baisser une sosu-catégorie, si c'est la dernière sous-catégorie qui s'affiche
                                    $ordreplus = $current_ordre + 1;
                                    $sql = "SELECT id_sous_cat FROM sous_categorie WHERE ordre_aff_sous_cat = :ordreplus AND id_cat = :ssid";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->bindParam('ordreplus', $ordreplus, PDO::PARAM_INT);
                                    $stmt->bindParam('ssid', $ssid, PDO::PARAM_INT);
                                    $stmt->execute();
                                    ...
                                    $previousId = $previousValue['id_sous_cat'];
                                    $sql = "UPDATE sous_categorie SET ordre_aff_sous_cat = :ordreplus WHERE id_sous_cat = :id AND id_cat = :ssid";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->bindParam('ordreplus', $ordreplus, PDO::PARAM_INT);
                                    $stmt->bindParam('id', $id, PDO::PARAM_INT);
                                    $stmt->bindParam('ssid', $ssid, PDO::PARAM_INT);
                                    $stmt->execute();
                                    $stmt = $pdo->prepare("UPDATE sous_categorie SET ordre_aff_sous_cat = :current_ordre WHERE id_sous_cat = :previousId AND id_cat = :ssid");
                                    $stmt->bindParam('current_ordre', $current_ordre, PDO::PARAM_INT);
                                    $stmt->bindParam('previousId', $previousId, PDO::PARAM_INT);
                                    $stmt->bindParam('ssid', $ssid, PDO::PARAM_INT);
                                    $stmt->execute();
                        ...
                        case "update cat": {
                                ...
                                $reqUP->bindParam('nom_cat', $nom_cat, PDO::PARAM_STR);
                                $reqUP->bindParam('id_cat', $id_cat, PDO::PARAM_INT);
                                $reqUP->execute();
                                header('location: /SGRC/index.php?page=categorie');
                                break;
                            }
                        ...
                        case "update sous cat": {
                                ...
                                $reqUP->bindParam('nom_sous_cat', $nom_sous_cat, PDO::PARAM_STR);
                                $reqUP->bindParam('couleur', $couleur, PDO::PARAM_STR);
                                $reqUP->bindParam('id_cat', $id_cat, PDO::PARAM_INT);
                                $reqUP->bindParam('id_sous_cat', $id_sous_cat, PDO::PARAM_INT);
                                $reqUP->execute();
                        ...
                        case "suppr cat": {
                                ...
                                $stmtordre->bindParam(':id', $id, PDO::PARAM_INT);
                                $stmtordre->execute();
                                ...
                                $row = $stmt->fetch(PDO::FETCH_ASSOC);
                                $maximum = $row['MAX(ordre_affichage_cat)'];
                                while ($current_ordre < $maximum) {//On modifie l'ordre d'affichage des autres catégories
                                    $ordreplus = $current_ordre + 1;
                                    $sql = "SELECT id_cat FROM categorie_plat WHERE ordre_affichage_cat = :ordreplus";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->bindParam(':ordreplus', $ordreplus, PDO::PARAM_INT);
                                ...
                                $stmt = $pdo->prepare("DELETE FROM sous_categorie WHERE id_cat = :id_cat");//On supprime les sous-catégorie de la catégorie quand on supprime cette dernière
                        ...
                        case "suppr sous cat": {
                                ...
                                $stmtordre = $pdo->prepare($sql);
                                $stmtordre->bindParam('id', $id, PDO::PARAM_INT);
                                $stmtordre->bindParam('ssid', $ssid, PDO::PARAM_INT);
                                $stmtordre->execute();
                                $currentValue = $stmtordre->fetch();
                                $current_ordre = $currentValue['ordre_aff_sous_cat'];
                                $sql = "SELECT MAX(ordre_aff_sous_cat) FROM sous_categorie WHERE id_cat = :ssida AND id_cat = :ssidb";
                                $stmt = $pdo->prepare($sql);
                                $stmt->bindParam('ssida', $ssid, PDO::PARAM_INT);
                                $stmt->bindParam('ssidb', $ssid, PDO::PARAM_INT);
                                $stmt->execute();
                                $row = $stmt->fetch();
                                $maximum = $row['MAX(ordre_aff_sous_cat)'];
                                while ($current_ordre < $maximum) { //On modifie l'ordre d'affichage des autres sous-catégories dans la catégorie
                                    $ordreplus = $current_ordre + 1;
                                    $sql = "SELECT id_sous_cat FROM sous_categorie WHERE ordre_aff_sous_cat = :ordreplus AND id_cat = :ssid";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->bindParam('ordreplus', $ordreplus, PDO::PARAM_INT);
                            ...
                            //Si la commande n'est pas connue, un message d'erreur s'affiche
                        default: {
                ...
                //recup la date du ticket
                //Vérifier si utile ici (utilisé normalement dans la caisse)
                //Permet de récupérer la date du ticket et de l'heure pour l'afficher sur le tableau de bord
                ...
                //ça permet de choisir la prochaine page qui sera afficher
                if (isset($_GET["page"])) {
                    switch ($_GET["page"]) {
                        case "tableau": {
                        ...
                        case "boisson": {
                            ...
                            //Quand on affiche la page qui liste tout les menus, on desselectionne dans la session le menu courant
                            //Ceci est dû au fait que dans la page menu, on a des actions qui agissent sur un seul menu
                        case "menu": {
                                unset($_SESSION['id_m']);
                        ...
                        case "suppr_sous_cat": {
                            ...
                            //Pour pouvoir préremplire le formulaire de modification, on récupère les informations de la catégorie
                        case "modif_categorie": {
                                $id_t = $_POST['id_t'];
                                $Requete_edit_cat = $pdo->prepare("SELECT * FROM `categorie_plat` WHERE id_cat = :id_t");
                                $Requete_edit_cat->bindParam('id_t', $id_t, PDO::PARAM_INT);
                        ...
                        case "modif_sous_cat": {
                                ...
                                $Requete_edit_cat->bindParam('id_c', $id_c, PDO::PARAM_INT);
                                $Requete_edit_cat->execute();
                                $cat = $Requete_edit_cat->fetchALL(PDO::FETCH_ASSOC);
                        ...
                        case "sous_categorie": {
                                ...
                                if (isset($_SESSION['id_t'])) {
                                    ...
                                    $statmt35->bindParam('idw', $idw, PDO::PARAM_INT);
                                    $statmt35->execute();
                                    ...
                                    $statmt35->bindParam('id_t', $id_t, PDO::PARAM_INT);
                                    $statmt35->execute();
                                    $sous_cats = $statmt35->fetchAll(PDO::FETCH_ASSOC);
                                    include "view/admin/categorie/sous_categorie.php";
                                }
                        ...
                        case "carte_menu": {
                                if (isset($_SESSION['id_m'])) {
                                    ...
                                    $cartes = $requete_carte->fetchAll();
                                                                    ...
                                                                    /* Cette requête SQL sélectionne les sous-catégories qui ont des plats associés dans le menu du jour. 
                                                                    Elle joint les tables sous_categorie et plat, 
                                                                    puis vérifie si chaque sous-catégorie a des plats dans le menu actuel via une sous-requête. 
                                                                    Les résultats sont groupés par nom de sous-catégorie et triés selon l'ordre d'affichage. */
        ...
        case "cuisine": {
                ...
                if (isset($_POST) && isset($_POST['action'])) {
                    switch ($_POST['action']) {
                        case "etatEnCours": { //Mettre la ligne ticket à 'En cours', On peut passer à l'état 'En cours' si le plat a été demander par le serveur
                                try {
                        ...
                        case 'etatPret': { //Indiquez que le plat est prêt à servir
                                try {
                                    $id_ticket = $_POST['id_ticket'];
                                    $id_plat = $_POST['id_plat'];
                                    $commentaire = $_POST['commentaire'];
                                    ...
                                    $sql = 'UPDATE ligne_ticket SET Etat = "Pret" WHERE id_ticket = :id_ticket AND id_plat = :id_plat AND Etat = :etat AND ' . $commentaireCondition;
                                    $stmt = $pdo->prepare($sql);
                        ...
                        default: {//Message d'erreur si commande n'est pas reconnue
                                echo "erreur d'action: " . $_POST["action"];
                                break;
                            }
                    }
                ...
                //Récupération des informations de couleurs pour l'affichage
                $statmt17 = $pdo->prepare('SELECT sous_categorie.couleur, plat.id_sous_cat, ticket.id_ticket, plat.id_plat, plat.nom_plat, COUNT(nom_plat) AS quantite, ligne_ticket.commentaire,ligne_ticket.Etat AS Etat, categorie_plat.ordre_affichage_cat, sous_categorie.ordre_aff_sous_cat FROM ligne_ticket, plat, ticket, categorie_plat, sous_categorie  WHERE ticket.id_ticket = :id_ticket AND ticket.id_ticket = ligne_ticket.id_ticket AND plat.id_plat = ligne_ticket.id_plat AND type_plat != "boisson" AND categorie_plat.id_cat = sous_categorie.id_cat AND plat.id_sous_cat = sous_categorie.id_sous_cat GROUP BY nom_plat, ligne_ticket.commentaire, Etat ORDER BY CASE WHEN type_plat = "entree" THEN 1 WHEN type_plat = "plat" THEN 2 WHEN type_plat = "dessert" THEN 3 ELSE 4 END, CASE WHEN Etat = "servi" THEN 2 WHEN Etat = "prêt" THEN 1 ELSE 0 END,  categorie_plat.ordre_affichage_cat, sous_categorie.ordre_aff_sous_cat;');
        ...
        case "bar": {
                ...
                if (isset($_POST) && isset($_POST['action'])) {
                    switch ($_POST['action']) {
                        case "etatEnCours": { //Passage à "En cours" de la boisson demandé
                                try {
                                    $id_ticket = $_POST['id_ticket'];
                                    $id_plat = $_POST['id_plat'];
                                    $commentaire = $_POST['commentaire'];
                        ...
                        case 'etatPret': { //Indique "Prêt" sur la boisson demandé
                                try {
                                    $id_ticket = $_POST['id_ticket'];
                                    $id_plat = $_POST['id_plat'];
                                    $commentaire = $_POST['commentaire'];
                        ...
                        default: {//Message d'erreur si commande non reconnue
                                echo "erreur d'action: " . $_POST["action"];
                                break;
                            }
                    }
                ...
                $statmt17 = $pdo->prepare('SELECT sous_categorie.couleur, plat.id_sous_cat, ticket.id_ticket, plat.id_plat, plat.nom_plat, COUNT(nom_plat) AS quantite, ligne_ticket.commentaire,ligne_ticket.Etat AS Etat, categorie_plat.ordre_affichage_cat, sous_categorie.ordre_aff_sous_cat FROM ligne_ticket, plat, ticket, categorie_plat, sous_categorie  WHERE ticket.id_ticket = :id_ticket AND ticket.id_ticket = ligne_ticket.id_ticket AND plat.id_plat = ligne_ticket.id_plat  AND type_plat = "boisson" AND categorie_plat.id_cat = sous_categorie.id_cat AND plat.id_sous_cat = sous_categorie.id_sous_cat GROUP BY nom_plat, ligne_ticket.commentaire, Etat ORDER BY CASE WHEN Etat = "servi" THEN 2 WHEN Etat = "prêt" THEN 1 ELSE 0 END, categorie_plat.ordre_affichage_cat, sous_categorie.ordre_aff_sous_cat, plat.nom_plat, ligne_ticket.commentaire;');
                $statmt17->bindParam(':id_ticket', $u, PDO::PARAM_INT);
        ...
        case "service": {
                ...
                if (isset($_POST) && isset($_POST['action'])) {
                    switch ($_POST['action']) {
                        ...
                        case "choix_table": {//Permet de sélectionner la table d'on vas s'occuper le serveur
                                $num_table = $_POST['numero_table_voulue'];
                                $statmt = $pdo->prepare('SELECT id_table FROM sgr_table WHERE numero_table = :num_table');
                                $statmt->bindParam('num_table', $num_table, PDO::PARAM_STR);
                                $statmt->execute();
                                ...
                                $reqete = "INSERT INTO `ticket` (`id_ticket`, `id_table`, `id_user`, `statut`, `date_c`) VALUES (NULL, :id, :iuc, 'CRE', :date_c)";
                                $statmt = $pdo->prepare($reqete);
                                $statmt->bindParam('id', $id, PDO::PARAM_INT);
                                $statmt->bindParam('iuc', $id_utilisateur_connecte, PDO::PARAM_INT);
                                $statmt->bindParam('date_c', $date_creation, PDO::PARAM_STR);
                                $statmt->execute();
                                }
                        ...
                        case "oublier_table": {//Retour en arrière
                                $id_t = $_POST['id_ticket'];
                                $stmt = $pdo->prepare("UPDATE`ticket` set `statut`= 'VAL' WHERE `id_ticket` = :id_ticket");//Quand on quitte la table dans l'affichage, le ticket qui a été créé est considérer comme validé et plus en création
                        ...
                        case "affecter_nb_couvert"; {//Affecte le nombre de couverts
                        ...
                        case "cree_ligne_ticket": {//Ajouter un plat ou une boisson à la commande
                        ...
                        case "diminue_ligne_ticket": {//Reduire la quantité d'un plat
                                try {
                                    $id_plat = $_POST['id_plat'];
                                    $id_ticket = $_POST['id_ticket'];
                                    $commentaire = $_POST['commentaire'];
                        ...
                        case "modifier_commentaire": {//Modifier le commentaire
                                try {
                                    $id_plat = $_POST['id_plat'];
                                    $id_ticket = $_POST['id_ticket'];
                                    $commentaire = $_POST['commentaire'];
                        ...
                        case "supprimer_ligne_ticket": {//Supprimer un plat ou une boisson de la commande
                        ...
                        case "etatEncours": {//C'est lorsque le serveur demande le plat en cuisine
                            try{
                                $id_ticket = $_POST['id_ticket'];
                                $id_plat = $_POST['id_plat'];
                                $commentaire = $_POST['commentaire'];
                        ...
                        case "etatServi": {//Indiquez qu'on a servi le plat
                            try{
                                $id_ticket = $_POST['id_ticket'];
                                $id_plat = $_POST['id_plat'];
                                $commentaire = $_POST['commentaire'];
        ...
        case "caisse": {
                //liste des actions de l'interface caisse
                //Pour l'instant la seule action que peut faire la caisse est d'indiquer que la ligne à été payé
