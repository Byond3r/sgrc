                    ...
                    switch ($_POST['action']) {
                        ...
                        case "choix_table": {
                                ...
                                if ($nb_ticket_ouvert == 0) {
                                    ...
                                    $reqete = "INSERT INTO `ticket` (`id_ticket`, `id_table`, `id_user`, `statut`) VALUES (NULL, $id, $id_utilisateur_connecte, 'CRE')";
                                    $pdo->exec($reqete);
                                }
