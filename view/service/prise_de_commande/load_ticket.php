...
// Récupérer l'identifiant du ticket depuis les paramètres GET
$idTicket = $_GET['idTicket'];
//NOUVEAU CODE A TEST 
...
// try {
//     $requeteInsertionDate = $pdo->prepare("
//         UPDATE ticket 
//         SET date_c = :dateCommande 
//         WHERE id_ticket = :idTicket 
//         AND date_c IS NULL
//     ");

//     $requeteInsertionDate->bindParam(':dateCommande', $dateCommande);
//     $requeteInsertionDate->bindParam(':idTicket', $idTicket, PDO::PARAM_INT);

//     $requeteInsertionDate->execute();
