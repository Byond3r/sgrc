...
?>
    ...
    <p class="refresh">Actualiser l'affichage <span style="font-weight: bold;" id="reloadStatus"> OFF</span></p>
    <label class="switch">
...
<!-- 
  ...
  <script>
    ...
    const aestheticSwitch = document.getElementById('customSwitchLabel');
    ...
    customSwitch.addEventListener('change', function () {
      if (customSwitch.checked) {
        ...
        // Désactiver le bouton esthétique
        aestheticSwitch.disabled = true;
      } else {
        clearInterval(refreshInterval);

        // Activer le bouton esthétique
        aestheticSwitch.disabled = false;
      }
                                ...
                                ?>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST">
                                            ...
                                            <input type="text" class="champ" name="commentaire" size="5" value="<?php echo isset($_POST['commentaire']) ? htmlspecialchars($_POST['commentaire']) : $plat['commentaire']; ?>">
